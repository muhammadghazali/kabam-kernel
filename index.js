...
function MWC(config) {
    ...
    var thisMWC=this;
    thisMWC.config=config;
    thisMWC.setCoreFunctions=[];
    thisMWC.setAppParametersFunctions=[];
    thisMWC.setAppMiddlewaresFunctions=[];
    thisMWC.setAppRoutesFunctions=[];
    return this;
}
...
//too busy middleware which blocks requests when we're too busy
    ...
    thisMWC.setAppParametersFunctions.map(function(middleware){
        //todo - add path to implement middleware
        if(middleware.enviroment){
            app.configure(middleware.enviroment,function(){
                middleware.SettingsFunction(thisMWC);
            });
        } else {
            middleware.SettingsFunction(thisMWC);
        }
    ...
    thisMWC.setAppMiddlewaresFunctions.map(function(func){
        func(thisMWC);
    });
