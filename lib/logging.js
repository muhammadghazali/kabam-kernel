...
function KabamLogging (winston) {
  this.container = new winston.Container();
  this.patchedLoggers = {};
}

KabamLogging.prototype._getModuleName = function _getModuleName (module) {
  var found = false,
    acc = '',
    packageJson,
    packageName;
...
KabamLogging.prototype.get = function get (name, module, namespace) {
  var _this = this,
    logger,
    patchedLogger;
  // jshint expr: true
...
KabamLogging.prototype.getLogger = function getLogger (name, module, namespace) {
  // module
  // module, namespace
...
KabamLogging.prototype.getLoggers = function(){
  return this.container.loggers;
};

var logging = new KabamLogging(winston);
